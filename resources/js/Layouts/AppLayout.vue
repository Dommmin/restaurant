                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            <div class="ms-3 relative flex gap-2 items-center">
                                <Link :href="route('cart.index')" class="indicator">
                                    <span
                                        class="indicator-item indicator-bottom indicator-end badge badge-primary text-white dark:text-gray-900 text-xs px-1.5 py-1"
                                ...
                                <Link class="btn btn-sm" :href="route('login')" v-if="!$page.props.auth.user">
                                    Login
                                </Link>
                            ...
                            <div class="ms-3 relative" v-if="$page.props.auth.user">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <DropdownLink :href="route('user.orders')">
                                            Orders
                                        </DropdownLink>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                        ...
                        <div v-if="$page.props.auth.user" class="mt-3 space-y-1">
                            ...
                            <ResponsiveNavLink :href="route('user.reservations')" :active="route().current('user.reservations')">
                                Reservations
                            </ResponsiveNavLink>

                            <ResponsiveNavLink :href="route('user.orders')" :active="route().current('user.orders')">
                                Orders
                            </ResponsiveNavLink>
